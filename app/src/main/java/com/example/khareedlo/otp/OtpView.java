...
package com.example.khareedlo.otp;
...
public class OtpView extends AppCompatEditText {
  ...
  public OtpView(Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, R.attr.otpViewStyle1);
  }
  ...
  public OtpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    viewType = typedArray.getInt(R.styleable.OtpView_viewType1, VIEW_TYPE_RECTANGLE);
    otpViewItemCount = typedArray.getInt(R.styleable.OtpView_itemCount1, DEFAULT_COUNT);
    otpViewItemHeight = (int) typedArray.getDimension(R.styleable.OtpView_itemHeight1,
        res.getDimensionPixelSize(R.dimen.otp_view_item_size));
    otpViewItemWidth = (int) typedArray.getDimension(R.styleable.OtpView_itemWidth1,
        res.getDimensionPixelSize(R.dimen.otp_view_item_size));
    otpViewItemSpacing = typedArray.getDimensionPixelSize(R.styleable.OtpView_itemSpacing1,
        res.getDimensionPixelSize(R.dimen.otp_view_item_spacing));
    otpViewItemRadius = (int) typedArray.getDimension(R.styleable.OtpView_itemRadius1, 0);
    lineWidth = (int) typedArray.getDimension(R.styleable.OtpView_lineWidth1,
    ...
    cursorColor = typedArray.getColor(R.styleable.OtpView_cursorColor1, getCurrentTextColor());
    cursorWidth = typedArray.getDimensionPixelSize(R.styleable.OtpView_cursorWidth1,
    ...
    hideLineWhenFilled = typedArray.getBoolean(R.styleable.OtpView_hideLineWhenFilled1, false);
    rtlTextDirection = typedArray.getBoolean(R.styleable.OtpView_rtlTextDirection1, false);
    maskingChar = typedArray.getString(R.styleable.OtpView_maskingChar1);
    typedArray.recycle();
    if (lineColor != null) {
